...
//		pastVeto1R = (NA_veto_rt_c[veto1bar]<vetoTDCcutmin || NA_veto_rt_c[veto1bar]>vetoTDCcutmax);
		pastVeto1L = (paddle->at(j)==barid && (TDCL->at(j)<vetoTDCcutmin || TDCL->at(j)>vetoTDCcutmax));
		pastVeto1R = (paddle->at(j)==barid && (TDCR->at(j)<vetoTDCcutmin || TDCR->at(j)>vetoTDCcutmax));
	}
